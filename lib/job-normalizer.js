...
const SKILL_ALIASES = {
  ...
  'Figma':          ['Figma', '피그마'],
  // 기획 관련
  '시스템/컨텐츠 기획': ['시스템기획', '시스템', '컨텐츠', '컨텐츠기획', '콘텐츠', '콘텐츠기획'],
  ...
  // 그 외
  '개발PM':          ['개발PM', '게임PM', '프로젝트관리', '프로젝트'],
  '사업PM':          ['사업PM', '사업관리', '서비스PM', '라이브PM'],
  '데이터 분석':     ['데이터분석', '데이터'],
  'Excel':           ['엑셀', 'Excel', 'PPT', 'MicrosoftOffice', 'MS-Office'],
  'JIRA/Confluence': ['JIRA', 'Confluence'],
  'Git/SVN':         ['Git', 'SVN'],
  'QA/테스트':       ['QA', '게임테스터'],
  '도트 아트':        ['도트', '도트아트', '픽셀아트', 'PixelArt'],
  '2D 그래픽 디자인': ['2D그래픽', '2D Graphic', '그래픽디자인'],
