...
- GitHub 기술문서화: 프로그래밍 직군은 public GitHub 저장소 URL을 입력하면 README, 루트 구조, 주요 설정 파일을 가볍게 분석해 기술문서 초안을 만듭니다.
...
- 플밍 직군은 public GitHub 저장소 URL을 입력하면 repo clone 없이 핵심 메타데이터만 확인합니다. private repo는 현재 지원하지 않습니다.
